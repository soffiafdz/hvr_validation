...
\vspace*{2cm}\par
\centering
\input{/path/to/user/project/hvr_validation/tables/table_clean-s1_man-seg_hcv-hvr_cv.tex}
\centering
\input{/path/to/user/project/hvr_validation/tables/table_clean-s2_man-seg_anova_cv.tex}
\centering
\input{/path/to/user/project/hvr_validation/tables/table_clean-s3_man-seg_posthoc_cv_side.tex}
\centering
\input{/path/to/user/project/hvr_validation/tables/table_clean-s4_man-seg_posthoc_cv_segm1.tex}
\centering
\input{/path/to/user/project/hvr_validation/tables/table_clean-s5_man-seg_posthoc_cv_segm2.tex}
\centering
\input{/path/to/user/project/hvr_validation/tables/table_clean-s6_man-seg_hcv-hvr_val.tex}
\centering
\input{/path/to/user/project/hvr_validation/tables/table_clean-s7_man-seg_anova_val.tex}
\clearpage
\section*{Supplementary Figures}
\vspace*{2cm}\par
\begin{figure}[h]
\centering
\includegraphics{/path/to/user/project/hvr_validation/plots/fig-s1_man-seg_comp_valid.png}
...
\begin{figure}[h]
\centering
\includegraphics{/path/to/user/project/hvr_validation/plots/fig-s2_man-seg_corr_valid.png}
...
\begin{figure}[h]
\centering
\includegraphics{/path/to/user/project/hvr_validation/plots/fig-s3_man-seg_blandaltman_valid.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{/path/to/user/project/hvr_validation/plots/fig-s4_adni-bl_hcv-hvr_corrs_perms_malf.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{/path/to/user/project/hvr_validation/plots/fig-s5_adni-bl_hcv-hvr_corrs_perms_nlpb.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{/path/to/user/project/hvr_validation/plots/fig-s6_adni-bl_hcv-hvr_corrs_perms_cnn.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{/path/to/user/project/hvr_validation/plots/fig-s7_adni-bl_hcv-hvr_corrs_perms_fs6.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{/path/to/user/project/hvr_validation/plots/fig-s8_adni-bl_hvr_corrs_perms_cnn-fs6.png}
